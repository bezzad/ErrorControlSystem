...
namespace ErrorControlSystem.Shared
{
    ...
    public static class OperationSystem
    {
        ...
        #region EDITION
        static private string _sEdition;
        /// <summary>
                                    ...
                                    out ed))
                                {
                                    switch (ed)
                                    {
                                        ...
                                        case PRODUCT_DATACENTER_SERVER_CORE:
                                            edition = "Data Center Server (core installation)";
                                            break;
                                        case PRODUCT_DATACENTER_SERVER_V:
                                            edition = "Data Center Server without Hyper-V";
                                            break;
                                        case PRODUCT_DATACENTER_SERVER_CORE_V:
                                            edition = "Data Center Server without Hyper-V (core installation)";
                                            break;
